...
#    Updated: 2025/05/18 19:02:09 by albermud         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBFT =		libft/libft.a
SRCS =		src/env_copy.c src/env_ft_export_print.c src/env_ft.c src/env_ft2.c src/execution.c src/execution_wait_fork.c src/expand_var.c src/expand_var_utils.c \
