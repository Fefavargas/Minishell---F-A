...
#    Updated: 2025/05/18 21:01:27 by fefa             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =		src/env_copy.c src/env_util.c src/expand_var.c src/expand_var_utils.c \
			src/fdfile.c src/heredoc.c src/initialize.c src/main.c \
			src/signal.c src/token_type.c \
			...
			src/others/error.c src/others/reset.c src/others/util_free.c \
			src/parse/ft_join_special.c src/util.c src/parse/ft_split_special_util.c src/parse/ft_split_special.c src/parse/parse.c src/parse/parse_space.c
